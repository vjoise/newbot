package com.stampbot.lang.service.corpus;
...
public class CorpusProcessor {
    ...
    public CorpusProcessor(String filename, int rowSize, boolean countFreq) throws Exception {
        this(new ClassPathResource(filename).getInputStream(), rowSize, countFreq);
    }
